package eu.thesystems.cloud.reformcloud1.client;
/*
...
public class ReformCloud1Client extends ReformCloud1 {
    public ReformCloud1Client() {
        super(SupportedCloudSystem.REFORMCLOUD_1_CLIENT, "ReformCloud1-Client");
    }
