package eu.thesystems.cloud.reformcloud1.controller;
/*
...
public class ReformCloud1Controller extends ReformCloud1 {

    public ReformCloud1Controller() {
        super(SupportedCloudSystem.REFORMCLOUD_1_CONTROLLER, "ReformCloud1-Controller");
    }
