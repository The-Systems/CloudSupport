package eu.thesystems.cloud.reformcloud1.bukkit;
/*
...
public class ReformCloud1Bukkit extends ReformCloud1 {
    public ReformCloud1Bukkit() {
        super(SupportedCloudSystem.REFORMCLOUD_1_BUKKIT, "ReformCloud1-Bukkit");
    }
